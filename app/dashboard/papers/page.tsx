    ...
    <div className="grid h-full gap-4 p-4 xl:grid-cols-[0.92fr_1.08fr]">
      <section className="rounded-[24px] border border-white/8 bg-[#171717] p-5">
        <div className="mb-6 space-y-2">
          <p className="text-sm uppercase tracking-[0.24em] text-mist">Papers</p>
          ...
          <p className="max-w-xl text-sm leading-6 text-mist">
            Paste an arXiv link, a PDF/article URL, or drag in a local PDF. The app extracts text, sections, references, and figures before you summarize.
          </p>
        </div>
        <PaperImportForm />
      </section>
      ...
      <section className="rounded-[24px] border border-white/8 bg-[#121212] p-5">
        <div className="mb-6 flex items-end justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-mist">Library</p>
        ...
        <div className="space-y-3">
          {papers.length ? (
            ...
            <div className="rounded-3xl border border-dashed border-white/10 p-6 text-sm leading-6 text-mist">
              No papers imported yet. Start with an arXiv link, article URL, or local PDF.
            </div>
          )}
        </div>
      </section>
